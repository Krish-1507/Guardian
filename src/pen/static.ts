/**
 * pen/static.ts — the static phase of `guardian pen`.
 *
...
const TEST_CRED_RE = /(test|demo|sample|example|fake|guardian|mock)/i;
...
const STATIC_RULES: StaticRule[] = [
  ...
  },
  {
    ...
    fix: "Install helmet and `app.use(helmet());` after app creation (deterministic patch generated by `guardian pen --fix` when helmet is already installed).",
  },
  {
